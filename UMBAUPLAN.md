...
| 22 | **Tempo und Betrieb: Bilder über nginx, Messung, Fehler- und Tempo-Logs, Auto-Checks, Alarme** | umgesetzt: #232, #233 Teil 1, #265 Betrieb II, #517 Teil 1 Alarme (#525), #231 Leseweg (#534) | #263, #266, #299 |
...
| Web: Tempo und Betrieb | Block 15 und 22: #221, #232, #233, #265 (#299) umgesetzt; #223 offen, #231 klassischer Leseweg – umgesetzt in #534 (Block 51.4); dazu #310 Livestreams der Mitglieder fehlen auf der Startseite (Bug vom 16.09.) |
...
| Admin sauber I: ein Ort je Thema | Rundgang 25.09.: #508 (#523), #509 (#522), #511 (#524), #513/#514 (#519), #515 (#520) – Block 48.15; #510 Dolibarr-Schalter (#539), #516 Nutzermenü (#540), #512 Adminmenü (#543) – Block 51.7; #546 Einstellungen in die Menüleiste + Alle Verbindungen – PR #549 (Block 51.10) |
...
| Betrieb & Logs: ein Logsystem mit Alarmen | #517 Teil 1 Alarme – umgesetzt in #525; Teil 2 eine Seite „Betrieb & Logs“ – PR #550 (Block 51.10); offen: gemeinsames Schreibmodell `ops_events` |
...
## Block 46 — Web: Design II, Teil 1: Kalender auf der Website

### Was 46.1 gefunden hat (#402 – PR #413)

**Die App hatte einen Kalender, die Website nicht.** Seit #216 zeigt die App einen Monat mit
Punkten je Tag; die Website hatte nur die Event-Liste und je Termin zwei Knöpfe „In meinen
Kalender“. Wer wissen wollte, was diesen Monat los ist, musste Events, Turniere und Fast Lap
einzeln durchgehen. Jetzt stellt der Server die Termine einmal zusammen (`/api/calendar`) – Events,
Turniere samt Anmeldeschluss als eigener Eintrag, Fast-Lap-Challenges –, und die Website zeigt
denselben Monat wie die App: Punkte je Art, goldener Rahmen bei eigener Anmeldung, die Termine des
angetippten Tags darunter, rechts „Als Nächstes“. Vereinstermine erscheinen nach dem Login, weil
der Server dieselbe Sichtbarkeitsregel anwendet wie überall (#342).

**Abo statt Einzel-Download.** Ein Kalender, den man abonniert, bleibt von selbst aktuell. Der Feed
...
### Was 46.3 gefunden hat (#400 – PR #424)

**Der Löwe klebte auf dem Code.** `BrandedQRCode` legte ein rundes weißes Feld über die Mitte und
skalierte das Raster-Maskottchen um 12 % hoch – bei 82 bis 116 px unscharf, mit hartem Ring. Der
Betreiber wollte kein neues Logo, sondern sein bestehendes (PNG unter Branding → „QR-Logo“, das
Feld gab es bereits). Jetzt zeichnet die Website den Code selbst aus der Modulmatrix: abgerundete
Module, Suchmuster in der Akzentfarbe, eine abgerundete Platte mit Ruhezone, das Logo scharf
darauf. Fehlerkorrektur H, Platte höchstens 24 % der Kante – weit unter dem, was H verkraftet.
Dieselbe Komponente an allen Stellen (TV-Ansichten, Mitgliedskarte, Downloads), nur die Größe
ändert sich.
...
ihre Partner (ein Haken je Partner im Formular); ihre Seiten nennen den Partner mit Link, die
Partnerseite zeigt Events und Turniere unter „Gemeinsam“ – nur, was die Person sehen darf. „Spieler bei
beiden Vereinen“ kommt nicht: dafür fehlen die Daten des Partners.
...
schmalen Spalte, der Rest des Bildschirms blieb leer. Jetzt liegt der Text in Lesebreite links mit
großem Bild, rechts eine Seitenleiste mit Angaben (Autor, Datum, Kategorie, Lesezeit), Teilen,
verknüpften Events oder Turnieren, erwähnten Personen und weiteren News; am Handy stapelt sich das
wie bisher. Eine erste Überschrift im Text, die nur den Titel wiederholt, steht nicht mehr doppelt.

### Was 46.10 gefunden hat (#409 Design – PR #457)

**Die Referenzen waren eine Liste gleichförmiger Karten – dem Betreiber gefiel das nicht.** Die Seite
ist jetzt eine Erfolgswand: oben die Medaillenbilanz (Gold, Silber, Bronze, hochzählend), dann jeder
Podestplatz als Trophäe mit Spiel-Cover, großer Platzierung, Liga, Saison und Aufstellung, darunter
die Bilanz je Spiel (zugleich Filter) und alle Teilnahmen als Zeitleiste nach Saison. Die
Detailseite trägt das Cover als Hero. Ohne Bilder funktioniert alles genauso – Cover gibt es heute
bei Call of Duty; für andere Spiele lohnt das Hochladen (Admin → Spiele).

### Was 46.9 gefunden hat (#409 – PR #445)

**Eine Referenz hatte genau eine Platzierung.** Der Verein nimmt aber an einem Turnier teil –
darunter ein Team mit gemeinsamer Platzierung oder mehrere Einzelstarter mit je eigener. Dazu
steckten Plattform, Format, Liga und Saison als Muster im Titel (`[PS] HC | Liga X | Cup`), das die
Seite zerbrechlich zerlegte. Jetzt ist eine Referenz eine Turnierteilnahme mit Einträgen (Team oder
Einzel), die vier Merkmale sind Felder mit Vorschlagslisten, und die Seite zeigt je Teilnahme die
beste Platzierung und alle Einträge in Podest-Optik; drei Zahlen oben statt acht, Filter nach
Saison. Alte Referenzen bleiben lesbar (ein Eintrag, Felder aus dem Titel abgeleitet) und werden
...
## Block 51 — Alte Meilensteine und Rundgang-Welle II (24. September, abends)

**Der Betreiber wollte die alten Meilensteine fertig haben („gib Vollstoff, will weiterkommen“) und
hatte die offenen Fragen als Kommentare beantwortet.** Zwölf PRs an einem Abend, alle gemergt;
danach drei Dinge, die er beim Einrichten von Google fand (Google-Prüfung, Einstellungen als
...
**Der Seiten-Reiter des Web-CMS war nirgends angebunden.** Entscheidung A: weg damit; was
gebraucht wurde, sind die E-Mail-Vorlagen – jede Mail mit Zweck, Empfänger und Variablen,
Betreff und Text überschreibbar, Vorschau mit Beispieldaten, Testmail, Zurücksetzen.

### Was 51.2 gefunden hat (#401 Turnierseite – PR #532)

**Die Turnierseite bot je Phase drei Knöpfe und dieselben Termine an zwei Stellen.** Jetzt eine
Hauptaktion je Phase, ein Kasten „Dein Stand“, die Termine einmal als Zeitleiste, Bracket/
Spielplan/Tabellen als Reiter, Teilnehmer mit Teamgröße.

### Was 51.3 gefunden hat (#531 Vereinsakte ohne Einladungscode – PR #533, Modul 1.4.0)

**„Warum geht das nicht automatisch, sobald man Mitglied ist?“** Ab Vereine 1.4.0 handelt die
Website mit `?member_id=` im Namen des Mitglieds, wenn die Zuordnung bestätigt ist – kein
Einladungscode mehr. Fehlt dem API-Benutzer das Recht „Über die API im Namen jedes Mitglieds
handeln“, sagt es die Stand-Zeile; ein altes Modul fällt auf Bindung/Einladung zurück und wird
als zu alt gekennzeichnet (Wunsch: die Modulversion soll egal sein, sonst markieren).

### Was 51.4 gefunden hat (#231 klassischer Leseweg – PR #534)

**Der Trockenlauf zählte 0 Altlasten – der klassische `matches`-Speicher wurde trotzdem noch von
elf Stellen gelesen.** Jetzt liest nur der Graph-Speicher; Rechte am Match kommen aus Turnier +
Stufe (`_match_policy`), das Trockenlauf-Skript bleibt als Beweis. Routeninventar unverändert.

### Was 51.5 gefunden hat (#527, #521 Konten – PR #535, #536)

**Socials standen im öffentlichen Profil dreimal.** Ein Kasten „Konten“ mit Socials und
Spielkonten, getippte Adressen zeigen den Namen, verifizierte den Haken (Web und App). Und im
eigenen Profil: statt Textfeld je Plattform der offizielle „Mit … anmelden“-Knopf, wo es eine
Anmeldung gibt; die Privatsphäre gilt weiter.

### Was 51.6 gefunden hat (#324 Rest, Vertrag 1.4.0 – PR #538)

**Eigene Rechnungen gingen nur über die Vereinsakte-Bindung.** Jetzt auch über die bestätigte
Zuordnung (Modul 1.4.0: `GET /vereine/me/invoices`, PDF mit SHA-256). Die Altlast der Uploads
wandert nach #537.

### Was 51.7 gefunden hat (#510, #516, #512 – PR #539, #540, #543)

**Dolibarr-Schalter lagen auf vier Seiten, das Nutzermenü hatte doppelte Ziele, das Adminmenü
hieß anders als die Seiten.** Ein Reiter „Funktionen“ mit echten Schaltern (`PUT
/admin/dolibarr/features`), ein Ziel je Menüeintrag mit Zählern nur bei Strafen/Gewinnen, und
Menüname = Seitentitel bei allen Seiten; Dolibarr bei den Mitgliedern.

### Was 51.8 gefunden hat (#541 Plattform-Liste – PR #542, #506 Profil ↔ Konto – PR #544)

**„Die Social-Links sind sehr begrenzt, X fehlt.“** Eine Liste (`lib/socialIcons.js`) für
Footer, Einstellungen, Suche und App. **„Profil erstellen“ legte still Mitgliedschaften an.**
Ein Profil ist kein Konto und keine Mitgliedschaft: Kasten „Konto“ im Admin (suchen, verknüpfen,
lösen, Bild/Spiele übernehmen), das Mitglied übernimmt über die Dolibarr-Zuordnung das
Vorstandsprofil statt ein zweites anzulegen, ein gelöstes Konto bleibt gelöst.

### Was 51.9 gefunden hat (#545 Google-Prüfung – PR #548, offen)

**Google bemängelte: Datenschutz zu dünn, Startseite „braucht Anmeldung“, Zweck unklar, Name
passt nicht.** Ursache: Crawler bekamen nur die Server-Vorschau mit einem Satz. Die Rechtstexte
liegen jetzt im Backend (eine Quelle), die Vorschau liefert den ganzen Text, die Startseite sagt
ohne JavaScript, was Website und App tun; die Datenschutzerklärung nennt jede eingerichtete
Anbindung von selbst, bei Google mit dem Limited-Use-Hinweis. Der Name in der Console: THE LION
SQUAD.

### Was 51.10 gefunden hat (#546 Einstellungen ins Menü – PR #549, #517 Teil 2 – PR #550, offen)

**„Das Einstellungen-Menü ist wieder ein zweites Menü.“** Jeder Reiter ein Menüeintrag
(Verbindungen, E-Mail, Auftritt, System), ganz oben „Alle Verbindungen“ mit dem Zustand jeder
Anbindung – auch „gespeichert, aber nicht lesbar“, weil nach einem Server-Update alle
Verbindungen „weg“ wirkten und niemand prüfte, ob die Schlüssel zum
...
### Was 50.1 gefunden hat (#326 Nachtrag – PR #456)

**Der Haken „Vereinsdaten aus Dolibarr übernehmen“ hielt nie – nicht wegen des Hakens.** Live steht
Analytics auf „Google“ ohne Measurement-ID; die Einstellungsseite prüfte das vor jedem Speichern
der Markendaten, auch auf „Rechtliches“, „Branding“ und „Socials“. Jetzt greift die Prüfung nur,
wenn Analytics selbst geändert wird, und nennt den Reiter. Dazu ein Wegweiser: die Admin-Suche
findet jeden Reiter der Einstellungen und der Dolibarr-Seite („Steam“ → Login & Konten, „Google
Analytics“ → SEO, „Steuersätze“ → Dolibarr-Verbindung, „Wortfilter“ → Moderation), ohne dass das
Menü ohne Suche länger wird; die Dolibarr-Seite versteht `?tab=`.

### Was 50.2 gefunden hat (#260 Nachtrag – PR #458)

**Verknüpfte Konten waren im Profil nur ein kleiner Haken; Fehler der Plattform kamen als
„abgebrochen“ an.** Discord war ausgegraut, weil der Website die Discord-App (Client ID + Secret
derselben App wie der Bot) fehlt; Twitch braucht die Rückrufadresse in der Developer Console.
...
### Was 49.3 gefunden hat (#415 – PR #478)

**Niemand prüfte ein Bild, bevor es im Chat, als Avatar oder als Teamlogo sichtbar wurde – die App ist
ab 13 freigegeben, Google verlangt Moderation.** Jetzt prüft die Website jedes hochgeladene Bild im
Hintergrund: unauffällig, „Prüfung nötig“ (Chat-Bild bleibt verborgen, bis ein Mensch entscheidet) oder
entfernt (Quarantäne, Verweise weg, Treffer, Nachricht). Der Anbieter ist ein Schalter – selbst gehostet
als Standard, Google Vision für Gewalt, aus. Die Moderation sieht jede Entscheidung mit Vorschau und
dreht sie um; fällt der Anbieter aus, bleibt alles sichtbar und der Stand wird rot. Offen: AWS
Rekognition; „Prüfung nötig“ versteckt öffentliche Uploads nicht.
...
### Was 48.11 gefunden hat (Kanäle und Statuten-Archiv – PR #492)

**Die Kanäle des Vereins standen zweimal – im Modul und noch einmal von Hand auf der Website.** Mit
dem Haken „Kanäle aus Dolibarr übernehmen“ nehmen Footer und Suchmaschinen sie aus dem Modul, in der
Reihenfolge des Vereins; stehen dort keine, bleibt die Liste von Hand. Die Statutenfassungen stehen für
Mitglieder jetzt auch unter Vereinsdokumente – öffentliche für jedes Mitglied, nur für Mitglieder
freigegebene über die Bindung, das PDF über denselben Öffnen-Weg. Nebenbei ist der Reiter Social Links
aus der großen Einstellungsseite heraus (#223).

### Was 48.12 gefunden hat (Verzeichnis aus der Einwilligung – PR #493)

**Wer ins Mitgliederverzeichnis wollte, musste sich selbst eintragen – der Betreiber will es zentral
pflegen.** Jetzt reicht die Einwilligung in Dolibarr: Der Abgleich legt für jedes zugeordnete Mitglied mit
Zustimmung das Vereinsprofil an (Name aus der Mitgliederverwaltung, Foto und Spiele vom Konto), der
Vorstand ergänzt Foto und Bio im Admin, und der nächste Abgleich lässt das stehen. Ein Widerruf nimmt den
Eintrag offline – auch einen selbst angelegten –, eine neue Zustimmung holt ihn zurück; Gesperrtes bleibt
gesperrt. Das Mitgliedsfoto aus Dolibarr fehlt noch (dolibarr-vereine#255).

### Was 48.13 gefunden hat (Profil aus Dolibarr – PR #495, #496, Modul #256)

**Der Betreiber will Bio, Foto und Co. eines Mitglieds wahlweise in Dolibarr pflegen – und bei manchen
soll der Nachname nicht öffentlich stehen.** Das Vereinsmodul bekam dafür ein Website-Profil je Mitglied
(Gamertag, Kurztext, Spiele, Plattformen, Foto der Mitgliedskarte; nur mit der gewählten Einwilligung),
und der Abgleich der Website übernimmt, was dort steht – was dort leer bleibt, pflegt die Website. Namen
bleiben Sache des Vorstands auf der Website: ein selbst gesetzter Klarname (etwa nur der Vorname) bleibt
beim Abgleich stehen. Der Testvertrag steht damit auf API-Version 2 des Moduls.

### Was 48.15 gefunden hat (Rundgang 25.09. – PR #518, #519, #520, #522, #523, #524)

**Der Betreiber wollte die Website einmal komplett durchgeklickt haben – lokal, mit Wegwerf-Admin.**
135 Seiten mit Playwright: keine API-Fehler, aber zehn Adminseiten mit Planungs-Etiketten als
Kopfzeile, Issue-Nummern im UI-Text, Verbindungs-Seiten, die nur verlinken, Vereinsdaten doppelt,
verstreute Dolibarr-Schalter, sechs Log-Seiten, `/u/me` zum Login, „no_guild“ als Code und – auf
der Live-Seite – doppelte Vereinsmitglieder aus dem Abgleich. Daraus wurden drei Meilensteine
(„Admin sauber I“, „Mitglieder sauber“, „Betrieb & Logs“, Issues #504–#517) und diese PR-Welle.
Grundsatz seither: jedes Thema an genau einer Stelle, keine Seite, die nur verlinkt, Anleitungen
einmal (FAQ unter Einrichtung), Codes und Planungswörter nie im UI. Nebenbei entschied der
Betreiber, dass das Vereinsmodul neutral bleibt: Das Website-Profil besteht aus frei gewählten
Zusatzfeldern (Vereine 1.2.0, Feld-Format) – die Website-Seite dazu war in #501 gemergt worden,
aber in den toten Branch von #518, und kommt als #528 noch einmal.

### Was 48.14 gefunden hat (Stand sichtbar machen – PR #498, #499, #500)

**Der Betreiber konnte nicht sehen, ob das Verzeichnis aus der Einwilligung läuft und welche Felder
Dolibarr setzt.** Die Dolibarr-Übersicht hat jetzt eine Zeile dafür (welche Einwilligung gilt, wie
viele Einträge daher kommen), und jedes Mitgliederprofil im Admin sagt, was von der Mitgliedskarte
kommt – bevor der Vorstand es überschreibt und der nächste Abgleich es zurücksetzt. Der Testvertrag
ist auf das Release 1.1.0 gepinnt. Das eigene Website-Profil des Mitglieds (Modul #260, Vereine 1.2) liegt als
Entwurf in PR #501 und wird auf das endgültige Modul-Format umgebaut: Das Modul bleibt neutral, das Profil
besteht aus Zusatzfeldern, die der Verein selbst wählt – die Website ordnet sie dem Verzeichnis zu.
...
### Was 45.1 gefunden hat (#396, #397 – PR #411)

**Die App konnte kein Event mit Kosten buchen.** Sie schickte nur Begleitpersonen und Hinweis;
sobald ein Event Positionen hatte, antwortete der Server 400, und die Person sah nur „konnte nicht
gespeichert werden“. Beim Startgeld am Turnier konnte die App es längst. Jetzt rechnet sie
dieselbe Vorschau wie das Web (Preis je Person oder je Anmeldung, wählbare Zusätze, Summe mit
Begleitpersonen), verlangt den Kostenhaken und schickt die gewählten Positionen mit; an der eigenen
Anmeldung stehen Betrag, Belegnummer und Zahlungsstand, und was eine Änderung der Begleitpersonen
vor und nach dem Beleg bedeutet.

**Rechte kommen vom Server, nicht aus der Rolle im Client.** Wer Turniere leitet oder im Vorstand
ist, bekam im Web die Anmeldungen mit Status und Begleitpersonen – die App zeigte niemandem etwas,
weil die Route nur Staff-Rollen kannte und der Vorstand meist Spieler ist. Die Route weiß jetzt
selbst, wer die Liste sieht (`participant_view`) und wer einchecken darf (`can_check_in`, dieselbe
