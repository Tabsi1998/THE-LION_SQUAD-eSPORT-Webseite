...
### Offene PRs
- #556 (#547 Welle 2: Threads, Facebook, LinkedIn, Snapchat, Pinterest, Telegram als OpenID
  Connect mit ID-Token gegen die JWKS, Wargaming nur mit Application ID, Bungie mit zusätzlichem
  API Key; `PLATFORMS` kennt dafür `secret_field: None` und `extra_field`; Draft bis zum lokalen
  Check, dann ready). Offen danach: #547 Welle 3 (Bluesky, Mastodon), #239 (natives Modul),
  Rest von #223 (`AdminSettingsPage`), App 1.0.0-Rest (#412 wartet auf Google, #219
  Store-Eintrag), Später-Issues. Frage an den Betreiber (24.09. abends, offen): welche
...
10. Alte Meilensteine und Rundgang-Welle II (24.09. abends, Freigabe „gib Vollstoff“): #437 A
    ...
    Offen: #547 Welle 2 (PR #556), dann #239 und der Rest von #223.
