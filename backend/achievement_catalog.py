...
ACHIEVEMENT_TIERS_V41 = [
    ...
    _t("season_points_b", "season_points", 1, "Erste Ranglistenpunkte", "Sammle 25 Jahrespunkte.",
       condition_key="season_points_total", progress_target=25, points=25, icon="star"),
    _t("season_points_s", "season_points", 2, "Punktesammler", "Sammle 100 Jahrespunkte.",
       condition_key="season_points_total", progress_target=100, points=75, icon="star"),
    _t("season_points_g", "season_points", 3, "Ranglisten-Jäger", "Sammle 250 Jahrespunkte.",
       condition_key="season_points_total", progress_target=250, points=180, icon="star"),
    _t("season_points_p", "season_points", 4, "Jahreswertungs-Elite", "Sammle 500 Jahrespunkte.",
...
ACHIEVEMENT_TIERS_V42 = [
    ...
    _t("level_progression_8", "level_progression", 5, "Level 8", "Sammle 4900 Achievement-Punkte.",
       condition_key="achievement_points", progress_target=4900, points=450, icon="badge-plus"),
    _t("level_progression_10", "level_progression", 5, "Level 10", "Sammle 8100 Achievement-Punkte.",
       condition_key="achievement_points", progress_target=8100, points=700, icon="badge-plus"),
    _t("level_progression_12", "level_progression", 5, "Level 12", "Sammle 12100 Achievement-Punkte.",
       condition_key="achievement_points", progress_target=12100, points=1000, icon="badge-plus"),
    _t("level_progression_15", "level_progression", 5, "Level 15", "Sammle 19600 Achievement-Punkte.",
       condition_key="achievement_points", progress_target=19600, points=1500, icon="badge-plus"),
    _t("level_progression_20", "level_progression", 5, "Level 20", "Sammle 36100 Achievement-Punkte.",
       condition_key="achievement_points", progress_target=36100, points=2500, icon="badge-plus"),
...
def _add_generated_tiers():
    ...
    public_specs.extend([
        ...
        ("season_points", "season_points_total", 1000, "Punkte-Elite", "Sammle 1000 Jahrespunkte.", 900, "star"),
        ("season_points", "season_points_total", 2500, "Ranglisten-Mythos", "Sammle 2500 Jahrespunkte.", 2000, "star"),
