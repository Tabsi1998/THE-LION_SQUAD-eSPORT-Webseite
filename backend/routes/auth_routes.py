...
async def register(body: UserRegister, request: Request, response: Response):
    ...
    user_doc = {
        ...
        "threads_handle": None, "facebook_handle": None, "linkedin_handle": None, "snapchat_handle": None, "pinterest_handle": None, "telegram_handle": None, "wargaming_handle": None, "bungie_handle": None,
