...
export const FAQ_TOPICS = [
  ...
  },
  {
    ...
    questions: [
      ...
      { key: "plattformen", q: "Welche Plattformen können Mitglieder verknüpfen (Steam, Battle.net, Xbox, FACEIT, Roblox …)?", a: "Siebenundzwanzig per Anmeldung: Discord, Twitch, Steam, Battle.net, X, YouTube, TikTok, Riot, Xbox, Epic, FACEIT, start.gg, Roblox, osu!, Lichess, GitHub, Kick, Reddit, Spotify, Threads, Facebook, LinkedIn, Snapchat, Pinterest, Telegram, Wargaming.net, Bungie.net. Je Plattform eine Seite unter Verbindungen mit Client ID, Secret, Rückrufadresse und Prüfung (Steam und Lichess brauchen keine App, Wargaming nur die Application ID, Bungie zusätzlich den API Key; Meta, LinkedIn, Snap und Pinterest verlangen ein App-Review, vorher dürfen nur Tester verknüpfen). Eingerichtet heißt: der Knopf „Mit … verknüpfen“ erscheint im Profil. PlayStation, Nintendo, EA, Ubisoft, Rockstar und GOG bieten keine Anmeldung für Websites – die bleiben getippt.", to: "/admin/integrations/steam", label: "Verbindungen → Steam", guide: "steam" },
