...
export const FAQ_TOPICS = [
  ...
  },
  {
    ...
    questions: [
      ...
      { key: "saison", q: "Wie funktioniert die Jahreswertung?", a: "eSports → Saisons / Circuit: Saison anlegen, Punkte je Turnier und Fast Lap, Podien. Die Startseite zeigt die aktive Saison.", to: "/admin/seasons", label: "eSports → Saisons / Circuit" },
  ...
  },
  {
    ...
    questions: [
      ...
      { key: "navigation", q: "Wie ändere ich die Menüpunkte der Website?", a: "Content → Navigation: Einträge, Reihenfolge, Sichtbarkeit. Eigene Seiten kommen über Content → CMS-Seiten.", to: "/admin/nav", label: "Content → Navigation" },
