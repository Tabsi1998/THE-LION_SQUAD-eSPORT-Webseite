...
export const FAQ_TOPICS = [
  ...
  },
  {
    ...
    questions: [
      ...
      { key: "plattformen", q: "Welche Plattformen können Mitglieder verknüpfen (Steam, Battle.net, Xbox, FACEIT, Roblox …)?", a: "Neunzehn per Anmeldung: Discord, Twitch, Steam, Battle.net, X, YouTube, TikTok, Riot, Xbox, Epic, FACEIT, start.gg, Roblox, osu!, Lichess, GitHub, Kick, Reddit, Spotify. Je Plattform eine Seite unter Verbindungen mit Client ID, Secret, Rückrufadresse und Prüfung (Steam und Lichess brauchen keine App). Eingerichtet heißt: der Knopf „Mit … verknüpfen“ erscheint im Profil. PlayStation, Nintendo, EA und Ubisoft bieten keine Anmeldung für Websites – die bleiben getippt.", to: "/admin/integrations/steam", label: "Verbindungen → Steam", guide: "steam" },
