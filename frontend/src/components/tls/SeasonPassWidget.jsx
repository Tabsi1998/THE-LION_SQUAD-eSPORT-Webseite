        ...
        <div className="grid lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="mt-4 text-white/70 text-base max-w-md">
              {s.description || "Die Champion-Wertung des Vereins. Jedes Turnier und jede F1-Runde zählt für die Gesamtwertung."}
            </p>
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <div className="px-4 py-2.5 border border-white/15 rounded-sm text-xs uppercase tracking-widest text-white/60 font-bold">
                {standings.length} Fahrer im Rennen
              </div>
            </div>
          </div>
                ...
                {spotlight ? (
                  ...
                  >
                    ...
                    <div className="mt-4 flex items-end gap-4">
                      ...
                      <div className="pb-2">
                        <div className="text-[10px] uppercase tracking-widest text-white/40">Siege / Events</div>
