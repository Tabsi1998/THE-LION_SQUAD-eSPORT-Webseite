...
const ADMIN_SEARCH_TERMS = {
  ...
  "/admin/settings?tab=newsletter": ["newsletter", "rundmail", "empfaenger", "empfänger", "abo"],
  ...
  "/admin/dolibarr?tab=preview": ["umstellung", "vorschau", "trockenlauf", "mitgliedsarten", "konten bestaetigen", "konten bestätigen", "ohne konto"],
